...
export default function Post({ params }: TPostProps) {
  return (
    <div className="py-6 px-6 lg:py-12 text-center max-w-6xl mx-auto">
      ...
      <p>
        ...
        reiciendis saepe nostrum, deserunt eveniet rem fugit odit quia debitis
        architecto amet sit excepturi in ex consequatur inventore nisi
        veritatis.
      </p>
    </div>
  );
